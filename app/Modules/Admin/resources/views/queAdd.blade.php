        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">ADD QUESTIONS</h2>
              <a href="/admin/dashboard" class="btn btn-primary">BACK</a><br><br>
              <a href="/import-question" class="btn btn-primary">Import Ques</a><br><br>

             
              <form action="{{ route('addQna') }}" method="POST">
                @if(session('success'))
              ...
              <div class="align-items-center mb-4 col-sm-6">
                <div class="form-outline flex-fill mb-0 ">
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="submit" 
                      class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Add Question</button>
                  </div>
              </form>
