        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">USER EDIT INFO</h2>
             
              <a href="/usermanagement" class="btn btn-outline-primary">Go back</a><br><br>
              <form action="{{ url('updateuser/'.$data->id) }}" method="POST">
                ...
                <div class="form-outline mb-4">
                  <input type="text" name="name" id="name" class="form-control form-control-lg" value="{{$data->name}}" />
                  <label class="form-label" for="name">Enter Name</label>
                  <span class="text-danger">@error('name'){{ $message }}@enderror</span>
                </div>

                <div class="form-outline mb-4">
                  <input type="email" name="email" id="email" class="form-control form-control-lg" value="{{$data->email}}" />
